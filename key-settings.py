...
kmi = km.keymap_items.new('object.align', 'A', 'PRESS', alt=True)
...
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('object.origin_set', 'O', 'PRESS', ctrl=True)

# Map 3D View
km = kc.keymaps.new('3D View', space_type='VIEW_3D', region_type='WINDOW', modal=False)

kmi = km.keymap_items.new('view3d.move_object_to_cursor', 'W', 'PRESS', alt=True)
kmi = km.keymap_items.new('view3d.move_selecteds_to_active', 'W', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('view3d.set_origin_to_selected', 'Q', 'PRESS', alt=True)
kmi = km.keymap_items.new('view3d.set_origin_to_selected', 'Q', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('view3d.cursor3d', 'Q', 'PRESS')
